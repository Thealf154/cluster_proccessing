...
font_size = 10
font_path = os.path.join('./', 'ibm.ttf')
...
class ProcessVideo:
    ...
    def recolect_frames(self):
        ...
        while True:
            ...
            if ret == False:
                ...
                logger.info('Frame {} extraído'.format(frame_name))
                frame_count += 1
    ...
    def create_frame_ascii_art(self, frame_name):
        ...
        logger.info('Frame {} procesada'.format(frame_name))
    ...
    def write_ascii_to_image(frame_name, img):
        ...
        logger.info('Frame {} escrito'.format(frame_name))
    ...
    def join_frames(self):
        ...
        video = cv2.VideoWriter(self.output_video_name, cv2.VideoWriter_fourcc(*'XVID'), 30, self.original_dimensions)
    ...
    def extract_audio(self):
        ...
        command = "ffmpeg -i {} -ab 160k -ac 2 -ar 44100 -vn {}".format(path, self.extracted_audio_name)
